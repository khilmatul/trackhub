<div class="slider" id="sliders">
    ...
    <div class="slider-body px-1">
        <nav class="nav flex-column">
            ...
            <a class="nav-link px-3 {{ Request::is('dashboard/monitoring*') ? 'active' : '' }}" href="{{url('/monitoring')}}">
            ...
            <a class="nav-link px-3 {{ Request::is('dashboard/penumpang*') ? 'active' : '' }}" href="{{url('penumpang')}}">
                <i class="fa-solid fa-address-card fa-lg box-icon" aria-hidden="true"></i>Data Penumpang
            </a>
            <a class="nav-link px-3 {{ Request::is('dashboard/trayek*') ? 'active' : '' }}" href="{{url('trayek')}}">
                <i class="fa-solid fa-route fa-lg box-icon" aria-hidden="true"></i>Data Trayek
            </a>
            <a class="nav-link px-3 {{ Request::is('dashboard/angkutan*') ? 'active' : '' }}" href="{{url('angkutan')}}">
                <i class="fa-solid fa-car-side fa-lg box-icon" aria-hidden="true"></i>Data Angkutan
            </a>
            <a class="nav-link px-3 {{ Request::is('user') ? 'active' : '' }}" href="{{url('kelolaakun')}}">
