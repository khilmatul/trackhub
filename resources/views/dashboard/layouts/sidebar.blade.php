<div class="slider" id="sliders">
    ...
    <div class="slider-body px-1">
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link px-3 nav-item {{ Request::segment(1) === 'dashboard' ? 'active' : null }}" href="{{url('dashboard')}}">
                <i class="fa fa-gauge fa-lg box-icon" aria-hidden="true"></i>Dashboard
            </a>
            <a class="nav-link px-3 {{ Request::is('monitoring') ? 'active' : '' }}" href="{{url('/monitoring')}}">
                <i class="fa-solid fa-chart-simple fa-lg box-icon" aria-hidden="true"></i>Monitoring Trayek
            </a>
            <a class="nav-link px-3 {{ Request::is('rekapitulasi') ? 'active' : '' }}" href="{{url('rekapitulasi')}}">
                <i class="fa-solid fa-file-lines fa-lg box-icon" aria-hidden="true"></i>Rekapitulasi Penumpang
            </a>
            <a class="nav-link px-3 {{ Request::is('penumpang') ? 'active' : '' }}" href="{{url('penumpang')}}">
                <i class="fa-solid fa-address-card fa-lg box-icon" aria-hidden="true"></i>Data Penumpang
            </a>
            <a class="nav-link px-3 {{ Request::is('trayek') ? 'active' : '' }}" href="{{url('trayek')}}">
                <i class="fa-solid fa-route fa-lg box-icon" aria-hidden="true"></i>Data Trayek
            </a>
            <a class="nav-link px-3 {{ Request::is('angkutan') ? 'active' : '' }}" href="{{url('angkutan')}}">
                <i class="fa-solid fa-car-side fa-lg box-icon" aria-hidden="true"></i>Data Angkutan
            </a>
            <a class="nav-link px-3 {{ Request::is('kelolaakun') ? 'active' : '' }}" href="{{url('kelolaakun')}}">
